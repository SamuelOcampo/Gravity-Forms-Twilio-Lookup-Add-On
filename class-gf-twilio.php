 ...
 */
class GFTwilioLookup extends GFFeedAddOn {
	 ...
	 */
	protected $_version = GF_TWILIO_LOOKUP_VERSION;
	...
	public function init() {
		...
		add_action( 'wp_ajax_twilio_lookup', array( $this, 'twilio_lookup' ) );
		add_action( 'wp_ajax_nopriv_twilio_lookup', array( $this, 'twilio_lookup' ) );
	}
